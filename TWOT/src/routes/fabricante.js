...
router.post('/fabricante/insertar',(req,res)=>{
    ...
    const sql = `CALL PROC_FABRICANTE(${objfabricante.PROVEEDORES},${objfabricante.DIR_EMPRESA},${objfabricante.TEL_EMPRESA},${objfabricante.COR_EMPRESA},${objfabricante.NOM_PRODUCTO},${objfabricante.UNIDADES},${objfabricante.COS_PRODUCTO},1,'')`
